...
{
  private final MyDatabase database = new MyDatabase(DRIVER, URL, USER, PASSWORD);

  private static final String DRIVER = "org.postgresql.Driver";
  private static final String URL = "jdbc:postgresql://localhost:5432/postgres?currentSchema=run13";
  ...
  private static final String PASSWORD = "postgresqlPassword";
